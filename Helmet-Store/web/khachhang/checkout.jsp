                                    ...
                                    <div class="card border-0">
                                        <div class="card-header pb-0">
                                            ...
                                            <div class="form-group"> 
                                                ...
                                                <input type="text" value="<%= khachHang.getHoVaTen() != null ? khachHang.getHoVaTen() : ""%>" class="form-control form-control-sm" name="fullname" id="fullname" aria-describedby="helpId" placeholder="Enter name" required> 
                                            </div>
                                            <div class="form-group"> 
                                                <label for="email" class="small text-muted mb-1">Email</label> 
                                                <span style="color: red">${invalidEmail}</span>
                                                <input type="email" value="<%= khachHang.getEmail() != null ? khachHang.getEmail() : ""%>" class="form-control form-control-sm" name="email" id="" aria-describedby="helpId" placeholder="Email" required> 
                                            </div>
                                            <div class="form-group"> 
                                                <label for="phone" class="small text-muted mb-1">Phone number</label> 
                                                <input type="tel" value="<%= khachHang.getSoDienThoai() != null ? khachHang.getSoDienThoai() : ""%>" class="form-control form-control-sm" name="phone" id="" aria-describedby="helpId" placeholder="Enter Phone number" required> 
                                            </div>
                                            <div class="form-group"> 
                                                <label for="quocgia" class="small text-muted mb-1">Country</label> 
                                                <input type="text" value="<%= khachHang.getQuocTich() != null ? khachHang.getQuocTich() : ""%>" class="form-control form-control-sm" name="quocgia" id="" aria-describedby="helpId" placeholder="Enter Country" required> 
                                            </div>
                                            <div class="form-group"> 
                                                <label for="delivery" class="small text-muted mb-1">Delivery address</label> 
                                                <input type="text" value="<%= khachHang.getDiaChiNhanHang() != null ? khachHang.getDiaChiNhanHang() : ""%>" class="form-control form-control-sm" name="deliveryaddress" id="" aria-describedby="helpId" placeholder="Enter Delivery address" required> 
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="row justify-content-between">
                                                        ...
                                                        <div class="media-body my-auto">
                                                            <div class="row ">
                                                                <div class="col-auto">
                                                                    ...
                                                                    <input  type="hidden" value="<%=sp.getMasanpham()%>" name="masanpham">
                                                                    <input type="hidden"  value="<%=sp.getKichco()%>" name="sizesanpham">
                                                ...
                                                <div class=" pl-0 flex-sm-col col-auto my-auto">
                                                    ...
                                                    <input type="hidden"  value="<%=sp.getSoluong()%>" name="soluongsanpham">
                                                </div>
                                                <div class=" pl-0 flex-sm-col col-auto my-auto ">
                                                    <p><b><%=Money.getMoney(priceTemp)%> </b></p>
                                                    <input type="hidden" name="giatiensanpham" value="<%=priceTemp%> ">
                                                    <%
...
// Chuyển hướng đến URL đó
        ...
        document.addEventListener('DOMContentLoaded', function () {
            const voucherInputs = document.querySelectorAll('input[name="idmagiamgia"]');
            const shippingInput = document.querySelector('input[name="ship"]');

            voucherInputs.forEach(function (voucherInput) {
                voucherInput.addEventListener('change', function () {
                    if (this.checked) {
                        shippingInput.value = 0; // Set shipping to 0
            ...
            function updateTotal() {
                ...
                // Calculate new total
                const newTotal = subtotal + parseFloat(shippingInput.value);
