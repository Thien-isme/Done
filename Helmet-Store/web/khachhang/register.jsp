                                ...
                                <div class="card-body p-3 p-md-4 p-xl-5">
                                    ...
                                    <form action="<%=url%>/khach-hang" method="get">
                                        ...
                                        <div class="row gy-3 overflow-hidden">
                                            ...
                                            %>
                                            <span style="color: red">${requestScope.errorUsername}</span>
                                            ...
                                            <div class="col-12">
                                                <span style="color: red">${requestScope.errorConfirmPassword}</span>
                                                <div class="form-floating mb-3">
                                            ...
                                            <%
                                                String emailInvalid = request.getAttribute("emailInvalid") + "";
                                                emailInvalid = emailInvalid.equals("null") ? "" : emailInvalid;
                                            %>
                                         
                                              

                                            <div class="col-12">
                                                <span style="color: red">${requestScope.emailInvalid}</span> 
                                                <div class="form-floating mb-3">
                                                    <%
                                        ...
                                        <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-center mt-5">
                                            <a href="<%=url1%>/khachhang/login.jsp" class="link-secondary text-decoration-none">Have an account?</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
