                ...
                <div class="card p-3 mb-2">
                    ...
                    <div class="row align-items-center ">
                        ...
                        <div class="col-md-3">
                            ...
                            <h6>OrderDate:<br> <%=oh.getNgaydathang().toString().substring(0, 10) + " " + oh.getNgaydathang().toString().substring(11, 19)%> </h6>
                        </div>
                    ...
                    <div class="col-md-12 row">
                        ...
                        <div class="col-md-9 text-end">
                            ...
                            %>
                            <form action="khach-hang" method="get">
                                <input type="hidden" name="hanhdong" value="goToPreview">
                                <input type="hidden" name="orderID" value="<%=oh.getMadonhang()%>">
                                <input type="submit" class="btn btn-primary" value="Preview" style="width: 140px" >
                            </form>
