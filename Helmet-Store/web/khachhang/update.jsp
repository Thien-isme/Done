                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <div>
                                                <div class="d-flex justify-content-center mb-4">
                                                    ...
                                                    %>
                                                    <img id="selectedAvatar" src="<%=url%>/uploads/macdinh.jpg"
                                                         class="rounded-circle" style="width: 200px; height: 200px; object-fit: cover;" alt="" />
                                                    <%
                                                      }else{
                                                    %>
                                                    <img id="selectedAvatar" src="<%=url%>/uploads/<%=khachHang.getHinhAvatar()%>?v=<%=System.currentTimeMillis()%>"
                                                         class="rounded-circle" style="width: 200px; height: 200px; object-fit: cover;" alt="" />
                                                    <%
                                                      }  
                                                    %>    
                                                ...
                                                <div class="d-flex justify-content-center">
                                                    <div data-mdb-ripple-init class=" btn-rounded">
                                                        ...
                                                        <input type="file" name="avatar" class="form-control" id="customFile" onchange="displaySelectedImage(event, 'selectedAvatar')" required=""/>  
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row gx-3 mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" id="hoVaTen" type="text" placeholder="Enter full name" name="hoVaTen" value="<%=khachHang.getHoVaTen()==null?"":khachHang.getHoVaTen()%>">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label">Phone number</label>
                                                    <input type="text" class="form-control" placeholder="Enter phone number" name="soDienThoai" value="<%=khachHang.getSoDienThoai()==null?"":khachHang.getSoDienThoai()%>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row gx-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-control" name="gioiTinh">
                                                        <option value="<%=khachHang.getGioiTinh()%>"> <%=khachHang.getGioiTinh()==null?"Enter gender":khachHang.getGioiTinh()%></option>
                                            ...
                                            <div class="row gx-3 mb-3">
                                                <div class="col-md-6">
                                                    <label for="inputEmail4" class="form-label">Email *</label> <span style="color: red">${requestScope.EmailValidator}</span>
                                                    <input type="email" class="form-control" id="inputEmail4" placeholder="Enter email address" name="email" value="<%= khachHang.getEmail()==null?"":khachHang.getEmail()%>">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label">Country</label>
                                                    <input type="text" class="form-control" placeholder="Enter country" name="quocGia" value="<%= khachHang.getQuocTich()==null?"":khachHang.getQuocTich()%>">
                                                </div>
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label">Customer address</label>
                                                <input type="text" class="form-control" placeholder="Enter address" name="diaChiKhachHang" value="<%= khachHang.getDiaChiKhachHang()==null?"":khachHang.getDiaChiKhachHang()%>">
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label">Delivery address</label>
                                                <input type="text" class="form-control" placeholder="Enter delivery address" name="diaChiNhanHang" value="<%= khachHang.getDiaChiNhanHang()==null?"":khachHang.getDiaChiNhanHang()%>">
                                            </div>
