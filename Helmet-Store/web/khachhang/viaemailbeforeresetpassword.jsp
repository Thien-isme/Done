                                        ...
                                        <div class="col-12 col-lg-11 col-xl-10">
                                            <div class="card-body p-3 p-md-4 p-xl-5">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="mb-5">
                                                            <div class="text-center mb-4">
                                                                <a href="#!">
                                                                    <img src="<%=url1%>/GUI/images/logo.png" alt="" width="175" height="57">
                                                                </a>
                                                            </div>
                                                            <%
                                                                String preaction = request.getAttribute("prevaction")+"";
                                                                String email = "";
                                                                if(preaction.equals("fogotpassword")){
                                                            ...
                                                            <h6 class="text-center">OTP code has been sent to your email.(<%=email%>)</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <form action="<%= url%>/khach-hang" method="POST" action="<%=url%>/khach-hang">
                                                    ...
                                                    <input class="form-control" name="prevaction" value="<%=request.getAttribute("prevaction")%>" type="hidden">
