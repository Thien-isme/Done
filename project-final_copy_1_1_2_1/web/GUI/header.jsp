                    ...
                    <ul class="navbar-nav me-auto bg-infor ">
                        <li class="nav-item dropdown">
                            <a style="font-size: 20px;"  class="nav-link dropdown-toggle text-center" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> 
                                ...
                                %> 
                                <img style="width: 30px; height: 30px; border-radius: 50%" src="<%=url%>/uploads/AvatarMacDinh.png"  alt="?nh Avatar"> 
                                <%
                                    } else {
                                %>
                                                                <img style="width: 30px; height: 30px; border-radius: 50%" src="<%=url%>/uploads/<%=khachHang.getHinhAvatar()%>"  alt="?nh Avatar"> 
